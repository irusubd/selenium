...
//		jse.executeScript("arguments[0].setAttribute('name', 'log3')", element);
		...
		WebElement passwordField = driver.findElement(By.cssSelector("input[id='password'],[type='password'],[name='pwd2']"));
	...
	public void cssSelector2() throws InterruptedException {
		...
		//contains
		WebElement bookTitle = driver.findElement(By.cssSelector("h3[class*='sc_title sc_title_regular']"));
...
//		li[class*='sc_tabs_title']:not(.ui-state-active)
		...
		jseExecutor.executeScript("arguments[0].setAttribute('style', 'background:green; border:4px solid red;')", thirdMenuEntry);
		System.out.println(thirdMenuEntry.getText());
